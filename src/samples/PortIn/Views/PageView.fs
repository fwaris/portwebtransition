...
module PageView =
    ...
    let navBar (miag:Model) =
        (VStack() {
            (Grid([Dimension.Star],[Dimension.Star;Dimension.Star; Dimension.Star; Dimension.Star; Dimension.Star; Dimension.Star])) {
                ...
                Button(Icons.fa_user_pen,Nav ViewSummary)
                    ...
                    .textColor(Colors.Magenta)
                    .gridRow(2)
                Button(Icons.fa_id_card,Nav ViewAccountInfo)
                    .font(size=20.0, fontFamily=C.FA)
                    .background(Colors.Transparent)
                    .textColor(Colors.Magenta)
                    .gridRow(3)
