...
module Update =
    ...
    let update nav msg model =
        ...
        | FromRunningTask (Agentic.FromAgent.AccountNumber n) -> {model with accountInfo = {model.accountInfo with AccountNumber = Some n}}, Cmd.none
        | FromRunningTask (Agentic.FromAgent.BillingZip z) -> {model with accountInfo = {model.accountInfo with BillingZip = Some z}}, Cmd.none
        | FromRunningTask (Agentic.FromAgent.TransferPin p) -> {model with accountInfo = {model.accountInfo with TransferPin = Some p}}, Cmd.none
        | FromRunningTask (Agentic.FromAgent.TransferPinPageLocated) -> {model with accountInfo = {model.accountInfo with TransferPinPageLocated = true}}, Cmd.none
        | FromRunningTask (Agentic.FromAgent.Bill b) -> {model with accountInfo = {model.accountInfo with Bill = Some b}}, Cmd.none
